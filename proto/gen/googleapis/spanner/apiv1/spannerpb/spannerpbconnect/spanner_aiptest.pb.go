...
func (fx SpannerTestSuite) TestSession(ctx context.Context, options SpannerSessionTestSuiteConfig) {
	fx.T.Run("Session", func(t *testing.T) {
		...
		options.Service = func() SpannerClient { return fx.Client }
		options.test(t)
	})
}
...
type SpannerSessionTestSuiteConfig struct {
	...
	CreateResource func(ctx context.Context, parent string) (*spannerpb.Session, error)
...
func (fx *SpannerSessionTestSuiteConfig) testGet(t *testing.T) {
	...
	t.Run("missing name", func(t *testing.T) {
		fx.maybeSkip(t)
		_, err := fx.Service().GetSession(fx.Context(), connect.NewRequest(&spannerpb.GetSessionRequest{
			Name: "",
		}))
...
func (fx *SpannerSessionTestSuiteConfig) testDelete(t *testing.T) {
	...
	t.Run("missing name", func(t *testing.T) {
		fx.maybeSkip(t)
		_, err := fx.Service().DeleteSession(fx.Context(), connect.NewRequest(&spannerpb.DeleteSessionRequest{
			Name: "",
		}))
		assert.Equal(t, connect.CodeInvalidArgument, connect.CodeOf(err), err)
	})
...
func (fx *SpannerSessionTestSuiteConfig) create(t *testing.T, parent string) *spannerpb.Session {
	t.Helper()
