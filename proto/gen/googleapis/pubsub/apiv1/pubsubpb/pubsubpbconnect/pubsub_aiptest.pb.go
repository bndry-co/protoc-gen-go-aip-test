...
func (fx PublisherTestSuite) TestTopic(ctx context.Context, options PublisherTopicTestSuiteConfig) {
	fx.T.Run("Topic", func(t *testing.T) {
		...
		options.Service = func() PublisherClient { return fx.Client }
		options.test(t)
	})
}
...
type PublisherTopicTestSuiteConfig struct {
	...
	CreateResource func(ctx context.Context, parent string) (*pubsubpb.Topic, error)
	// Update should return a resource which is valid to update, i.e.
	// all required fields set.
	Update func(parent string) *pubsubpb.Topic
...
func (fx *PublisherTopicTestSuiteConfig) testUpdate(t *testing.T) {
	...
	t.Run("missing name", func(t *testing.T) {
		...
		msg.Name = ""
		_, err := fx.Service().UpdateTopic(fx.Context(), connect.NewRequest(&pubsubpb.UpdateTopicRequest{
			Topic: msg,
		}))
...

	{
		...
		t.Run("required fields", func(t *testing.T) {
			...
			t.Run(".name", func(t *testing.T) {
				fx.maybeSkip(t)
				msg := proto.Clone(created).(*pubsubpb.Topic)
				container := msg
				if container == nil {
...
func (fx *PublisherTopicTestSuiteConfig) create(t *testing.T, parent string) *pubsubpb.Topic {
	t.Helper()
...
func (fx SubscriberTestSuite) TestSnapshot(ctx context.Context, options SubscriberSnapshotTestSuiteConfig) {
	fx.T.Run("Snapshot", func(t *testing.T) {
		options.Context = func() context.Context { return ctx }
		options.Service = func() SubscriberClient { return fx.Client }
		options.test(t)
	})
}
...
type SubscriberSnapshotTestSuiteConfig struct {
	...
	// This method is generated because service does not expose a Create
	// method (or it does not comply with AIP).
	CreateResource func(ctx context.Context, parent string) (*pubsubpb.Snapshot, error)
	// Update should return a resource which is valid to update, i.e.
	// all required fields set.
	Update func(parent string) *pubsubpb.Snapshot
	// Patterns of tests to skip.
	// For example if a service has a Get method:
	// Skip: ["Get"] will skip all tests for Get.
	// Skip: ["Get/persisted"] will only skip the subtest called "persisted" of Get.
...
func (fx *SubscriberSnapshotTestSuiteConfig) testUpdate(t *testing.T) {
	...
	t.Run("missing name", func(t *testing.T) {
		...
		msg := fx.Update(parent)
		msg.Name = ""
		_, err := fx.Service().UpdateSnapshot(fx.Context(), connect.NewRequest(&pubsubpb.UpdateSnapshotRequest{
			Snapshot: msg,
		}))
		assert.Equal(t, connect.CodeInvalidArgument, connect.CodeOf(err), err)
	})
...
func (fx *SubscriberSnapshotTestSuiteConfig) create(t *testing.T, parent string) *pubsubpb.Snapshot {
	t.Helper()
	if fx.CreateResource == nil {
...
type SubscriberSubscriptionTestSuiteConfig struct {
	...
	// This method is generated because service does not expose a Create
	// method (or it does not comply with AIP).
	CreateResource func(ctx context.Context, parent string) (*pubsubpb.Subscription, error)
	// Update should return a resource which is valid to update, i.e.
	// all required fields set.
	Update func(parent string) *pubsubpb.Subscription
	// Patterns of tests to skip.
	// For example if a service has a Get method:
	// Skip: ["Get"] will skip all tests for Get.
	// Skip: ["Get/persisted"] will only skip the subtest called "persisted" of Get.
...
func (fx *SubscriberSubscriptionTestSuiteConfig) testUpdate(t *testing.T) {
	...
	t.Run("missing name", func(t *testing.T) {
		...
		msg := fx.Update(parent)
		msg.Name = ""
		_, err := fx.Service().UpdateSubscription(fx.Context(), connect.NewRequest(&pubsubpb.UpdateSubscriptionRequest{
			Subscription: msg,
		}))
		assert.Equal(t, connect.CodeInvalidArgument, connect.CodeOf(err), err)
	})
...

	{
		...
		t.Run("required fields", func(t *testing.T) {
			...
			t.Run(".name", func(t *testing.T) {
				fx.maybeSkip(t)
				msg := proto.Clone(created).(*pubsubpb.Subscription)
				container := msg
				if container == nil {
					t.Skip("not reachable")
				}
...
func (fx *SubscriberSubscriptionTestSuiteConfig) create(t *testing.T, parent string) *pubsubpb.Subscription {
	t.Helper()
	if fx.CreateResource == nil {
