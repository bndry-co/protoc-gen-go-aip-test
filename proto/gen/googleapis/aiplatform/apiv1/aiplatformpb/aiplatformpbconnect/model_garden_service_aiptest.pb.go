...
func (fx ModelGardenServiceTestSuite) TestPublisherModel(ctx context.Context, options ModelGardenServicePublisherModelTestSuiteConfig) {
	fx.T.Run("PublisherModel", func(t *testing.T) {
		...
		options.Service = func() ModelGardenServiceClient { return fx.Client }
		options.test(t)
	})
}
...
type ModelGardenServicePublisherModelTestSuiteConfig struct {
	...
	Service func() ModelGardenServiceClient
	...
	CreateResource func(ctx context.Context, parent string) (*aiplatformpb.PublisherModel, error)
...
func (fx *ModelGardenServicePublisherModelTestSuiteConfig) testGet(t *testing.T) {
	...
	t.Run("missing name", func(t *testing.T) {
		fx.maybeSkip(t)
		_, err := fx.Service().GetPublisherModel(fx.Context(), connect.NewRequest(&aiplatformpb.GetPublisherModelRequest{
			Name: "",
		}))
...
func (fx *ModelGardenServicePublisherModelTestSuiteConfig) create(t *testing.T, parent string) *aiplatformpb.PublisherModel {
	t.Helper()
