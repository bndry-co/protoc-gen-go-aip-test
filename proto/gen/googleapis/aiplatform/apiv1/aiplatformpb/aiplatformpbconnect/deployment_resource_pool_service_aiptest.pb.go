...
func (fx DeploymentResourcePoolServiceTestSuite) TestDeploymentResourcePool(ctx context.Context, options DeploymentResourcePoolServiceDeploymentResourcePoolTestSuiteConfig) {
	fx.T.Run("DeploymentResourcePool", func(t *testing.T) {
		...
		options.Service = func() DeploymentResourcePoolServiceClient { return fx.Client }
		options.test(t)
	})
}
...
type DeploymentResourcePoolServiceDeploymentResourcePoolTestSuiteConfig struct {
	...
	Service func() DeploymentResourcePoolServiceClient
	...
	Create func(parent string) *aiplatformpb.DeploymentResourcePool
...
func (fx *DeploymentResourcePoolServiceDeploymentResourcePoolTestSuiteConfig) testCreate(t *testing.T) {
	...
	t.Run("missing parent", func(t *testing.T) {
		fx.maybeSkip(t)
		_, err := fx.Service().CreateDeploymentResourcePool(fx.Context(), connect.NewRequest(&aiplatformpb.CreateDeploymentResourcePoolRequest{
			Parent:                 "",
...
func (fx *DeploymentResourcePoolServiceDeploymentResourcePoolTestSuiteConfig) testGet(t *testing.T) {
	...
	t.Run("missing name", func(t *testing.T) {
		fx.maybeSkip(t)
		_, err := fx.Service().GetDeploymentResourcePool(fx.Context(), connect.NewRequest(&aiplatformpb.GetDeploymentResourcePoolRequest{
			Name: "",
		}))
		assert.Equal(t, connect.CodeInvalidArgument, connect.CodeOf(err), err)
	})
...
func (fx *DeploymentResourcePoolServiceDeploymentResourcePoolTestSuiteConfig) testList(t *testing.T) {
	...
	t.Run("invalid parent", func(t *testing.T) {
		fx.maybeSkip(t)
		_, err := fx.Service().ListDeploymentResourcePools(fx.Context(), connect.NewRequest(&aiplatformpb.ListDeploymentResourcePoolsRequest{
			Parent: "invalid resource name",
		}))
		assert.Equal(t, connect.CodeInvalidArgument, connect.CodeOf(err), err)
	})
...

	{
		...
		parentMsgs := make([]*aiplatformpb.DeploymentResourcePool, resourcesCount)
		...
		t.Run("isolation", func(t *testing.T) {
			fx.maybeSkip(t)
			listResp, err := fx.Service().ListDeploymentResourcePools(fx.Context(), connect.NewRequest(&aiplatformpb.ListDeploymentResourcePoolsRequest{
				Parent:   parent,
				PageSize: 999,
			}))
			assert.NilError(t, err)
			...
			assert.DeepEqual(
				...
				cmpopts.SortSlices(func(a, b *aiplatformpb.DeploymentResourcePool) bool {
		...
		t.Run("one by one", func(t *testing.T) {
			fx.maybeSkip(t)
			msgs := make([]*aiplatformpb.DeploymentResourcePool, 0, resourcesCount)
		...
		t.Run("deleted", func(t *testing.T) {
			...
			for i := 0; i < deleteCount; i++ {
				_, err := fx.Service().DeleteDeploymentResourcePool(fx.Context(), connect.NewRequest(&aiplatformpb.DeleteDeploymentResourcePoolRequest{
...
func (fx *DeploymentResourcePoolServiceDeploymentResourcePoolTestSuiteConfig) create(t *testing.T, parent string) *aiplatformpb.DeploymentResourcePool {
	t.Helper()
