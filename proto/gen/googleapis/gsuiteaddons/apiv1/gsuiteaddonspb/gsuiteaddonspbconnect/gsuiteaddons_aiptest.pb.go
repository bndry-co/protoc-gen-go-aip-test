...
func (fx GSuiteAddOnsTestSuite) TestAuthorization(ctx context.Context, options GSuiteAddOnsAuthorizationTestSuiteConfig) {
	fx.T.Run("Authorization", func(t *testing.T) {
		...
		options.Service = func() GSuiteAddOnsClient { return fx.Client }
		options.test(t)
	})
}
...
type GSuiteAddOnsAuthorizationTestSuiteConfig struct {
	...
	Service func() GSuiteAddOnsClient
	...
	CreateResource func(ctx context.Context) (*gsuiteaddonspb.Authorization, error)
...
func (fx *GSuiteAddOnsAuthorizationTestSuiteConfig) testGet(t *testing.T) {
	...
	t.Run("missing name", func(t *testing.T) {
		fx.maybeSkip(t)
		_, err := fx.Service().GetAuthorization(fx.Context(), connect.NewRequest(&gsuiteaddonspb.GetAuthorizationRequest{
			Name: "",
		}))
...
func (fx *GSuiteAddOnsAuthorizationTestSuiteConfig) create(t *testing.T) *gsuiteaddonspb.Authorization {
	t.Helper()
...
type GSuiteAddOnsDeploymentTestSuiteConfig struct {
	...
	Create func(parent string) *gsuiteaddonspb.Deployment
	// Patterns of tests to skip.
	// For example if a service has a Get method:
	// Skip: ["Get"] will skip all tests for Get.
	// Skip: ["Get/persisted"] will only skip the subtest called "persisted" of Get.
...
func (fx *GSuiteAddOnsDeploymentTestSuiteConfig) testCreate(t *testing.T) {
	...
	t.Run("missing parent", func(t *testing.T) {
		fx.maybeSkip(t)
		_, err := fx.Service().CreateDeployment(fx.Context(), connect.NewRequest(&gsuiteaddonspb.CreateDeploymentRequest{
			Parent:     "",
	...
	t.Run("persisted", func(t *testing.T) {
		...
		createResp, err := fx.Service().CreateDeployment(fx.Context(), connect.NewRequest(&gsuiteaddonspb.CreateDeploymentRequest{
			Parent:     parent,
...
func (fx *GSuiteAddOnsDeploymentTestSuiteConfig) testGet(t *testing.T) {
	...
	t.Run("missing name", func(t *testing.T) {
		fx.maybeSkip(t)
		_, err := fx.Service().GetDeployment(fx.Context(), connect.NewRequest(&gsuiteaddonspb.GetDeploymentRequest{
			Name: "",
		}))
		assert.Equal(t, connect.CodeInvalidArgument, connect.CodeOf(err), err)
	})
...
func (fx *GSuiteAddOnsDeploymentTestSuiteConfig) testList(t *testing.T) {
	...
	t.Run("invalid parent", func(t *testing.T) {
		fx.maybeSkip(t)
		_, err := fx.Service().ListDeployments(fx.Context(), connect.NewRequest(&gsuiteaddonspb.ListDeploymentsRequest{
			Parent: "invalid resource name",
		}))
		assert.Equal(t, connect.CodeInvalidArgument, connect.CodeOf(err), err)
	})
...

	{
		...
		parentMsgs := make([]*gsuiteaddonspb.Deployment, resourcesCount)
		...
		t.Run("isolation", func(t *testing.T) {
			fx.maybeSkip(t)
			listResp, err := fx.Service().ListDeployments(fx.Context(), connect.NewRequest(&gsuiteaddonspb.ListDeploymentsRequest{
				Parent:   parent,
				PageSize: 999,
			}))
			...
			assert.DeepEqual(
				...
				cmpopts.SortSlices(func(a, b *gsuiteaddonspb.Deployment) bool {
		...
		t.Run("one by one", func(t *testing.T) {
			fx.maybeSkip(t)
			msgs := make([]*gsuiteaddonspb.Deployment, 0, resourcesCount)
		...
		t.Run("deleted", func(t *testing.T) {
			...
			for i := 0; i < deleteCount; i++ {
				_, err := fx.Service().DeleteDeployment(fx.Context(), connect.NewRequest(&gsuiteaddonspb.DeleteDeploymentRequest{
...
func (fx *GSuiteAddOnsDeploymentTestSuiteConfig) create(t *testing.T, parent string) *gsuiteaddonspb.Deployment {
	t.Helper()
	createResp, err := fx.Service().CreateDeployment(fx.Context(), connect.NewRequest(&gsuiteaddonspb.CreateDeploymentRequest{
		Parent:     parent,
		Deployment: fx.Create(parent),
...
type GSuiteAddOnsInstallStatusTestSuiteConfig struct {
	...
	// This method is generated because service does not expose a Create
	// method (or it does not comply with AIP).
	CreateResource func(ctx context.Context, parent string) (*gsuiteaddonspb.InstallStatus, error)
	// Patterns of tests to skip.
	// For example if a service has a Get method:
	// Skip: ["Get"] will skip all tests for Get.
	// Skip: ["Get/persisted"] will only skip the subtest called "persisted" of Get.
...
func (fx *GSuiteAddOnsInstallStatusTestSuiteConfig) testGet(t *testing.T) {
	...
	t.Run("missing name", func(t *testing.T) {
		fx.maybeSkip(t)
		_, err := fx.Service().GetInstallStatus(fx.Context(), connect.NewRequest(&gsuiteaddonspb.GetInstallStatusRequest{
			Name: "",
		}))
		assert.Equal(t, connect.CodeInvalidArgument, connect.CodeOf(err), err)
	})
...
func (fx *GSuiteAddOnsInstallStatusTestSuiteConfig) create(t *testing.T, parent string) *gsuiteaddonspb.InstallStatus {
	t.Helper()
	if fx.CreateResource == nil {
